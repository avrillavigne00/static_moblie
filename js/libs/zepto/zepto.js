/* Zepto 1.1.3 - zepto event data ajax fx selector touch - zeptojs.com/license */
        ...
        //if ((touch.x2 && Math.abs(touch.x1 - touch.x2) > swipelength) || //+
         //    (touch.y2 && Math.abs(touch.y1 - touch.y2) > swipelength)) //+
          ...
          swipeTimeout = setTimeout(function() {
            touch.el.trigger('swipe')
            var _direction = (swipeDirection(touch.x1, touch.x2, touch.y1, touch.y2));
            touch.el.trigger('swipe' + _direction)
